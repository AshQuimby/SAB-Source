...
public class Bullet extends BufferedProjectile {
   public Bullet(double x, double y, double velX, double velY, double kb, double kbDir, int owner, Player ownerPlayer) {
      damage = 12;
      width = 8;
      height = 8;
      life = 30;
